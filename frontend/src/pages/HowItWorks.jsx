  ...
  const steps = [
    {
      ...
      description:
        "Users must register or log in to perform operations such as posting auctions, bidding on items, accessing the dashboard.",
    },
    {
      icon: <FaGavel />,
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        ...
        >
          Discover How VIGGIEBidOut Operates
        </h1>
        <div className="flex flex-col gap-4 my-5">
          {steps.map((element, index) => {
            return (
              ...
              >
                <div className="bg-black text-white p-3 text-xl rounded-full w-fit group-hover:bg-[#23c686] transition-all duration-300">
                  {element.icon}
                </div>
                <h3
                  className={`text-[#23c686] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl`}
                >
                  {element.title}
                </h3>
